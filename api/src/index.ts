...
// CORS configuration for auth routes (needed for AuthSession flows)
app.use(
	'/api/auth/**',
	cors({
		origin: '*', // Replace with your production allow-list
...
// Middleware to initialize auth instance for each request and attach user context
