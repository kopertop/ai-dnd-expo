...
export default defineConfig([globalIgnores([
	...
	rules: {
		indent: ['error', 'tab', {
			...
			// Fix a weird bug with eslint and complex JSX expressions
			ignoredNodes: [
				'JSXFragment > *',
			]
		}],
		...
		'react-native/no-raw-text': [
			'error',
			{
				skip: ['Text', 'Label', 'Button', 'HeadingText', 'BodyText', 'CaptionText'],
			},
		],
		...
		// Enforce logical operators at the beginning of lines
