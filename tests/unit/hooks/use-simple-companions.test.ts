...
describe('useSimpleCompanions', () => {
  ...
  describe('storage operations', () => {
    it('should save companion data to storage', async () => {
      ...
      await mockAsyncStorage.setItem('ai-dnd-companions', companionsJson);
    ...
    it('should load companion data from storage', async () => {
      ...
      mockAsyncStorage.getItem.mockResolvedValueOnce(companionsJson);

      const result = await mockAsyncStorage.getItem('ai-dnd-companions');
      const parsedCompanions = JSON.parse(result!);
    ...
    it('should save party configuration to storage', async () => {
      ...
      await mockAsyncStorage.setItem('ai-dnd-party-config', configJson);
    ...
    it('should handle storage errors gracefully', async () => {
      ...
      await expect(mockAsyncStorage.getItem('ai-dnd-companions')).rejects.toThrow(
        'Storage unavailable'
      );
    });
  });
  ...
  describe('error handling and edge cases', () => {
    ...
    it('should handle storage save failures', async () => {
      ...
      await expect(
        mockAsyncStorage.setItem('ai-dnd-companions', '{}')
    ...
    it('should handle storage load failures', async () => {
      ...
      await expect(
        mockAsyncStorage.getItem('ai-dnd-companions')
  ...
  describe('performance considerations', () => {
    ...
    it('should handle concurrent operations safely', async () => {
      const savePromises = [
        ...
        mockAsyncStorage.setItem('key3', 'value3'),
      ];
