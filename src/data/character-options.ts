...
// Public assets are served at the root path, so we use string paths instead of imports
const artificerImage = '/assets/images/classes/artificer.png';
const barbarianImage = '/assets/images/classes/barbarian.png';
const bardImage = '/assets/images/classes/bard.png';
const clericImage = '/assets/images/classes/cleric.png';
const druidImage = '/assets/images/classes/druid.png';
const fighterImage = '/assets/images/classes/fighter.png';
const monkImage = '/assets/images/classes/monk.png';
const paladinImage = '/assets/images/classes/paladin.png';
const rangerImage = '/assets/images/classes/ranger.png';
const rogueImage = '/assets/images/classes/rogue.png';
const sorcererImage = '/assets/images/classes/sorcerer.png';
const warlockImage = '/assets/images/classes/warlock.png';
const wizardImage = '/assets/images/classes/wizard.png';
const customImage = '/assets/images/custom.png';
const dragonbornImage = '/assets/images/races/dragonborn.png';
const dwarfImage = '/assets/images/races/dwarf.png';
const eladrinImage = '/assets/images/races/eladrin.png';
const elfImage = '/assets/images/races/elf.png';
const gnomeImage = '/assets/images/races/gnome.png';
const halfElfImage = '/assets/images/races/half-elf.png';
const halfOrcImage = '/assets/images/races/half-orc.png';
const halflingImage = '/assets/images/races/halfling.png';
const humanImage = '/assets/images/races/human.png';
const tieflingImage = '/assets/images/races/tiefling.png';
const acrobaticsImage = '/assets/images/skills/acrobatics.png';
const arcanaImage = '/assets/images/skills/arcana.png';
const athleticsImage = '/assets/images/skills/athletics.png';
const bluffImage = '/assets/images/skills/bluff.png';
const diplomacyImage = '/assets/images/skills/diplomacy.png';
const dungeoneeringImage = '/assets/images/skills/dungeoneering.png';
const enduranceImage = '/assets/images/skills/endurance.png';
const healImage = '/assets/images/skills/heal.png';
const historyImage = '/assets/images/skills/history.png';
const insightImage = '/assets/images/skills/insight.png';
const intimidateImage = '/assets/images/skills/intimidate.png';
const natureImage = '/assets/images/skills/nature.png';
const perceptionImage = '/assets/images/skills/perception.png';
const religionImage = '/assets/images/skills/religion.png';
const stealthImage = '/assets/images/skills/stealth.png';
const streetwiseImage = '/assets/images/skills/streetwise.png';
const thieveryImage = '/assets/images/skills/thievery.png';
const arcaneTattooedImage = '/assets/images/traits/arcane-tattooed.png';
const artifactEmbeddedImage = '/assets/images/traits/artifact-embedded.png';
const celestialBloodImage = '/assets/images/traits/celestial-blood.png';
const draconicHeritageImage = '/assets/images/traits/draconic-heritage.png';
const elementalFireImage = '/assets/images/traits/elemental-fire.png';
const elementalIceImage = '/assets/images/traits/elemental-ice.png';
const feytouchedImage = '/assets/images/traits/feytouched.png';
const infernalTaintImage = '/assets/images/traits/infernal-taint.png';
const markedByDeathImage = '/assets/images/traits/marked-by-death.png';
const runebloodedImage = '/assets/images/traits/runeblooded.png';
const shadowboundImage = '/assets/images/traits/shadowbound.png';
const spellscaredImage = '/assets/images/traits/spellscared.png';
const starcursedImage = '/assets/images/traits/starcursed.png';
const stormtouchedImage = '/assets/images/traits/stormtouched.png';
