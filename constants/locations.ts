...
export const LOCATIONS: LocationOption[] = [
	...
	// 	id: 'prison',
	// 	name: 'Prison',
	// 	description: 'A dungeon cell, for escape, rescue, or wrongful imprisonment.',
	// 	image: require('../assets/images/locations/prison.png'),
	// },
	// {
	// 	id: 'library',
	// 	name: 'Library',
	...
	// 	id: 'workshop',
	// 	name: 'Workshop',
	// 	description: 'A forge or laboratory, for crafting and invention.',
	// 	image: require('../assets/images/locations/workshop.png'),
	// },
	// {
	// 	id: 'street',
	// 	name: 'Street',
	// 	description: 'An urban alleyway, perfect for intrigue or chases.',
	// 	image: require('../assets/images/locations/street.png'),
	// },
	// {
	// 	id: 'farm',
	// 	name: 'Farm',
