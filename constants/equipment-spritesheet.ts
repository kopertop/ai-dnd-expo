...
export function getEquipmentSpritesheet(): SpriteSheetConfig | null {
	...
	try {
		...
		const iconLoader = require('../components/equipment-icons-frontend');
...
// EQUIPMENT_ICONS is lazy-loaded, don't call at module level to avoid backend bundling
// Use getEquipmentIcons() function instead
export const EQUIPMENT_ICONS: Record<string, ImageSourcePropType | string | { spritesheet: string; x: number; y: number } | undefined> = {};
